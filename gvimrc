...
" " Tells vim to use c-style indenting 
 set cindent 
"
" " No more press tab all day; the computers are gettings smarter
 set autoindent
"
"Line number
 set number
...
" Display match pattern for a search pattern halfway typing it
 map Q gq
...
"turn off error bells (sounds during mistakes)
set noerrorbells
